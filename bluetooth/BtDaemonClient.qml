...
Item {
    ...
    Process {
        ...
        onStarted: {
            client.ready = true;
            client.send({ id: "session-subscribe", op: "subscribe", streams: [BtApi.streams.changed, BtApi.streams.pairing, BtApi.streams.operation, BtApi.streams.scan, BtApi.streams.audio, BtApi.streams.obex] });
            client.flushQueue();
        }
