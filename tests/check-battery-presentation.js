...
equal(context.sleepCapabilityDescription({ ...sleep, can_hibernate: "no" }, "hibernate"), "Disabled or not permitted by system policy", "permission denial explained");
equal(context.sleepCapabilityDescription({ ...sleep, can_hibernate: "challenge" }, "hibernate"), "Authorisation required · configure system policy before sleeping", "authentication requirement explained");
...
for (const capability of ["inhibited", "inhibitor-blocked", "challenge-inhibitor-blocked"]) {
