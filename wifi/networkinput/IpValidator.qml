...
QtObject {
    function ipv4State(value) {
        return Validation.ipv4State(value);
    }
    function ipv6State(value) {
        return Validation.ipv6State(value);
    }
    function addressState(value, family) {
        return Validation.addressState(value, family);
    }
    ...
    function isIpv4(value) {
        return Validation.isIpv4(value);
    }
    function isIpv6(value) {
        return Validation.isIpv6(value);
    }
    function isAddress(value, family) {
        return Validation.isAddress(value, family);
    }
